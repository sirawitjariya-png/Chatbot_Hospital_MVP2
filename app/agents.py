...
def llm(messages: list, *, use_router: bool = False, **kw) -> str:
    ...
    # gpt-5-mini and o-series models require max_completion_tokens instead of max_tokens
    if "max_tokens" in kw:
    ...
    try:
        ...
        if usage:
            ...
            write_token_log(model, usage.prompt_tokens, cached, usage.completion_tokens)
